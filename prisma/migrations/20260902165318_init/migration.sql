...
-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING', 'ACCEPTED', 'CONFIRMED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', 'REJECTED');
...
-- CreateIndex
CREATE UNIQUE INDEX "AvailabilitySlot_providerId_serviceId_startTime_endTime_key" ON "AvailabilitySlot"("providerId", "serviceId", "startTime", "endTime");
...
-- AddForeignKey
ALTER TABLE "AvailabilitySlot" ADD CONSTRAINT "AvailabilitySlot_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "ProviderProfile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
